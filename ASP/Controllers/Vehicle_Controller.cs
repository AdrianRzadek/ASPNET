...
namespace ASP.Controllers
{
    public class Vehicle_Controller : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Description")] VehicleViewModel vehicle_)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Description")] VehicleViewModel vehicle_)
        {
            if (id != vehicle_.ID)
            {
                return NotFound();
