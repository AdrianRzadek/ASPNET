...
namespace ASP.Controllers
{
    public class RentalPointsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Address")] RentalPointViewModel rentalPoint)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Address")] RentalPointViewModel rentalPoint)
        {
